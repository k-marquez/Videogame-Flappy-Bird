...
OBJ_RULES = text_utilities.o Settings.o Game.o Bird.o Log.o LogPair.o World.o StateMachine.o TitleScreenState.o CountDownState.o PlayingState.o PauseState.o GameOverState.o HandlerHard.o HandlerRegular.o GameModeState.o Powerup.o
...
GameModeState.o: $(BUILD_DIR) src/states/GameModeState.hpp src/states/GameModeState.cpp
	$(CXX) -c $(INCLUDE) src/states/GameModeState.cpp -o $(BUILD_DIR)/$@
...
GameOverState.o: $(BUILD_DIR) src/states/GameOverState.hpp src/states/GameOverState.cpp
	$(CXX) -c $(INCLUDE) src/states/GameOverState.cpp -o $(BUILD_DIR)/$@
