...
struct Settings
{
    ...
    static constexpr float POWERUP_WIDTH{27.f};
    static constexpr float POWERUP_HEIGHT{30.f};
    ...
    static constexpr float PROBABILITY{10.00f};
    static constexpr int TIME_POWERUP{10};
